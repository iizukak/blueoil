...
from lmnet.lmnet.networks.object_detection.{{network_module}} import {{network_class}}
from lmnet.lmnet.datasets.{{dataset_module}} import {{dataset_class}}
{% if data_augmentation %}from lmnet.lmnet.data_augmentor import ({% for augmentor in data_augmentation %}
    {{ augmentor[0] }},{% endfor %}
){% endif %}
