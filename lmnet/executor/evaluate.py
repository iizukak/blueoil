...
from lmnet.lmnet.utils import executor, module_loader
from lmnet.lmnet.utils.predict_output.writer import save_json
...
def evaluate(config, restore_path, output_dir):
    ...
    with graph.as_default():
        ...
        if ModelClass.__module__.startswith("lmnet.lmnet.networks.object_detection"):
            model = ModelClass(
